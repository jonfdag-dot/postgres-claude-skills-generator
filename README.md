...
<!-- Banner — Agentic Skills autogenerated for your org. Renders on github.com (user-attachments URL) and chion.ai (mirror at /assets/chion-banner.gif). -->
<a href="https://chion.ai/chion-md">
  <img
    src="https://github.com/user-attachments/assets/2a908e9b-9f86-4b52-9029-d8bb65b2a6e2"
    alt="Chion — Agentic Skills autogenerated for your org. Auto-generated Postgres SQL skills for Claude Code, Cursor, and Codex."
    width="100%"
  />
</a>
